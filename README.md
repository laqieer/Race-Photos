...
```bash
# Download photos/videos (see scripts README for platform-specific commands, including Kailishi, Alltuu's signed GET/POST bib search requests, Feipaom, RunFF's automatic multi-page fetch for >200 photos, and Yipai360 bib plus filename search)
